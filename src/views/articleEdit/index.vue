<template>
	<div>
		...
		<!-- 添加 -->
		<el-dialog title="添加文章" :visible.sync="addDialog" :close-on-click-modal="false" width="100%">
			...
			<el-form ref="form" :model="addOptions" label-width="120px">
				...
				<el-form-item label="内容:">
					　		<vue-ueditor-wrap v-model="addOptions.content" :config="myConfig" style="widt:100%!important;"></vue-ueditor-wrap>
				</el-form-item>
			</el-form>
...
this.$router.push({name:'aloneArticleEdit'})
			...
			//修改
			Update(obj) {
				this.$store.commit('setPersonalInfo',deepClone(obj))
