		...
		a.os.plus && a.os.android && a.addBack({
			...
			handle: function() {
				...
				return d ? d.evalJS("mui&&mui.back();") : c.canBack(function(d) {
					d.canBack ? b.history.back() : c.id === plus.runtime.appid ? a.__back__first ? (new Date).getTime() - a.__back__first < 2e3 && plus.runtime.quit() : (a.__back__first = (new Date).getTime(), mui.toast("鍐嶆寜涓€娆￠€€鍑哄簲鐢�"), setTimeout(function() {
	...
	function(a, b) {
		a.alert = function(c, d, e, f) {
			if (a.os.plus) {
				...
				"function" == typeof d ? (f = d, d = null, e = "纭畾") : "function" == typeof e && (f = e, e = null), a.plusReady(function() {
	...
	function(a, b, c) {
		var d = "mui-popup",
			...
			v = function(b, c, d, e, f) {
				return "undefined" != typeof b ? ("function" == typeof c ? (e = c, f = d, c = null, d = null) : "function" == typeof d && (f = e, e = d, d = null), a.os.plus && "div" !== f ? plus.nativeUI.alert(b, e, c || "鎻愮ず", d || "纭畾") : u(s(b, c || "鎻愮ず") + t([d || "纭畾"]), e)) : void 0
			},
			w = function(b, c, d, e, f) {
				return "undefined" != typeof b ? ("function" == typeof c ? (e = c, f = d, c = null, d = null) : "function" == typeof d && (f = e, e = d, d = null), a.os.plus && "div" !== f ? plus.nativeUI.confirm(b, e, c, d || ["鍙栨秷", "纭"]) : u(s(b, c || "鎻愮ず") + t(d || ["鍙栨秷", "纭"]), e)) : void 0
			},
			x = function(b, c, d, e, f, g) {
				return "undefined" != typeof b ? ("function" == typeof c ? (f = c, g = d, c = null, d = null, e = null) : "function" == typeof d ? (f = d, g = e, d = null, e = null) : "function" == typeof e && (g = f, f = e, e = null), a.os.plus && "div" !== g ? plus.nativeUI.prompt(b, f, d || "鎻愮ず", c, e || ["鍙栨秷", "纭"]) : u(s(b, d || "鎻愮ず", r(c)) + t(e || ["鍙栨秷", "纭"]), f)) : void 0
			},
			y = function() {
		...
		var c = "mui-active",
			...
			f = function(c, d) {
				if (this.element = c, this.options = a.extend({
						...
						duration: 16,
						scrollby: b
					}, d || {}), this.scrollByElem = this.options.scrollby || b, !this.scrollByElem) throw new Error("鐩戝惉婊氬姩鐨勫厓绱犱笉瀛樺湪");
				...
				if (!f.length) throw new Error("鍏冪礌鑳屾櫙棰滆壊蹇呴』涓篟GBA");
	...
	function(a) {
		var b = "ontouchstart" in document,
			...
			i = a.Numbox = a.Class.extend({
				init: function(b, c) {
					var d = this;
					if (!b) throw "鏋勯€� numbox 鏃剁己灏戝鍣ㄥ厓绱�";
